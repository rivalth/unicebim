...
import { calculateSmartBalance, getRemainingDaysInMonthUtc } from "@/features/dashboard/smart-balance";

describe("smart balance", () => {
  it("calculates remaining days in month (inclusive)", () => {
    // Dec 2025 has 31 days
    expect(getRemainingDaysInMonthUtc(new Date("2025-12-13T12:00:00Z"))).toBe(19);
    expect(getRemainingDaysInMonthUtc(new Date("2025-12-31T12:00:00Z"))).toBe(1);
  });
